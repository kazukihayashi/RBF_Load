...
namespace RBF_Load
{
    public class RBF_LoadComponent : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                // vertex position
                var pt_temp = mesh_out.Vertices.ToPoint3dArray();

                // mesh geometry
                showGeometryComponent = new Kangaroo2Component.GoalComponents.GeometryComponent();
                showGeometryComponent.Params.Input[0].AddVolatileData(new GH_Path(0), 0, mesh_out);
                ...
                lengthComponent.Params.Input[0].AddVolatileDataList(new GH_Path(0), ExtractMeshEdges(mesh_out));
                ...
                anchorComponent.Params.Input[0].AddVolatileDataList(new GH_Path(0), pt_fix_i.Select(pfi => pt_temp[pfi]).ToArray());
                ...
                anchorXYZComponent.Params.Input[0].AddVolatileDataList(new GH_Path(0), pt_temp);
                ...
                var mesh_temp_inc = EquilibriumShape(pt_temp, loadVec_temp);
                ...
                var mesh_temp_dec = EquilibriumShape(pt_temp, loadVec_temp);
                ...
                var mesh_temp_keep = EquilibriumShape(pt_temp, loadVec_temp);
                ...
                else
                {
                    ...
                    while (true)
                    {
                        ...
                        var mesh_temp = EquilibriumShape(pt_temp, loadVec_temp);
