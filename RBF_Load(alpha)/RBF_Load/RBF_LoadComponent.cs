...
namespace RBF_Load
{
    public class RBF_LoadComponent : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("alpha", "a", "Stepsize", GH_ParamAccess.item, 0.01);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            for (int iter = 0; iter < maxIter; iter++)
            {
                ...
                mesh_out = EquilibriumShape(pt_temp, loadVec_temp);
                variance = Zdiff(mesh_out, pt_target).Select(x => x * x).Sum();              
